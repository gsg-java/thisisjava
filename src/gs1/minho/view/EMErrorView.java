...
public class EMErrorView extends EMView {
        @ErrorView(comment = "Register Request 실패했을때 화면", request = "Register")
        ...
        @ErrorView(comment = "Delete Request 실패 했을때 화면", request = "Delete")
        public void deleteReqFail(Request request) {
            System.out.println("-------------------------실패----------------------------");
            System.out.println(((DeleteRequest)request).getName() + "님은 등록돼있지않습니다 ");
            System.out.println("--------------------------------------------------------");
        }

        @ErrorView(comment = "SearchByName Request 실패했을때 화면", request = "SearchByName")
        ...
        @ErrorView(comment = "ShowAll Request 실패했을때 화면", request = "ShowAll")
